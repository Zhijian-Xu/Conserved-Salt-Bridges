...
def get_com(selection,state=1,mass=1, quiet=1): 
   """
DESCRIPTION
   ...
   if totmass == 0:
      print("Warning: Total mass is zero, possibly no atoms selected in selection '{}'".format(selection))
      return 0, 0, 0 # 返回一个错误值或者其他处理方式
